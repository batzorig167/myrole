...
export default function Task() {
    ...
    <div className="flex justify-center justify-evenly">
        <div className="flex flex-col gap-1">
            ...
            <button className="px-4 py-1 text-white rounded-full bg-blue-500 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" onClick={handleBtn}>Авах</button>
        </div>
        {
            selectItem && (
