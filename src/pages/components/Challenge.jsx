    ...
    function closeHandle(){
     ...
     return <div>
        ...
        <div className="h-[80vh] flex flex-col justify-center items-center gap-2">
            <h1 className="text-xl flex justify-center">{"Таны сэтгэл зүйн түвшин:"+result}</h1>
        ...
        <div className="flex flex-col gap-5">
         {
             props.map((data,index)=>{
                 return <div key={index}>
                    ...
                    <button className="rounded-full text-center text-xl w-95 py-2 h-16 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:text-[#fff] text-black rounded-full hover:bg-[#f9593a] bg-blue-400" onClick={handleBtn}>{data.name}</button>
            ...
            {selectItem && (
                <div className="fixed top-0 left-0 w-[100vw] h-[100vh] ">
                    <div className="w-[100vw] h-[100vh] relative flex justify-center items-center">
                        ...
                        <div className="bg-gray-200 py-2 px-5 rounded-xl absolute z-[1] flex flex-col w-100 ">
                            <div className="flex flex-col justify-evenly gap-3">
                                <div className="flex justify-between">
                                <p className="text-xl "><strong className="text-black">Чалленжийн нэр: </strong>{data.name}</p>
                                    <button type="button" onClick={closeHandle} class="bg-gray-200 h-10 rounded-md inline-flex items-center justify-center text-black hover:text-gray-500 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-indigo-500">
