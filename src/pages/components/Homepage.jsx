...
export default function Homepage() {
    return <div className="max-auto-screen bg-white">
        <div className="flex flex-col justify-center">
            ...
            <div className=" flex flex-col gap-8 px-15 bg-[#e3f6f5] h-full py-20">
                <div className="items-center px-5 border border-black">
                        <p className="flex justify-center text-4xl pb-3 text-blue-700">Сэтгэл судлалын сайт</p>
                        <p className="flex justify-center text-2xl italic text-center px-20 text-black"> Энэхүү сэтгэл зүйн сайт нь хүмүүсийн сэтгэл зүйн эрүүл мэндийг дэмжих, зөвлөгөө өгөх, өөрийгөө хөгжүүлэх боломж олгох зорилготой. Энэ нь сэтгэлзүйн боловсрол түгээх, мэргэжлийн зөвлөгөө хүргэх, стресс, түгшүүрийг даван туулахад туслах платформ болно.</p>
                </div>
                <div className="flex flex-col gap-10">
                    <h1 className="flex justify-center text-3xl text-black">Өгч болох тестүүд</h1>
                    <div className="flex-col justify-center justify-evenly">
                        {/* <img src="https://insightfultraits.com/wp-content/uploads/2024/12/contender-f-min.png" alt="" className="h-80"/> */}
