...
export default function HomeTsesniihesg() {
    ...
    return <div className="flex flex-col pb-5 gap-2 rounded-[18px] md:flex-row md:items-center">
        <div className="flex md:flex-row flex-col items-center gap-5 p-5">
            <img src="https://thumbs.dreamstime.com/b/friendly-male-doctor-cartoon-character-floral-plant-decoration-346249083.jpg" alt="" className="h-60 flex md:h-auto pt-4"/>
        </div>
